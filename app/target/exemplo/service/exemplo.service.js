...
var ExemploService = (function () {
    function ExemploService(http) {
        this.http = http;
        this.exemploUrl = 'https://natanieltse.herokuapp.com/exemplo';
    }
    ExemploService.prototype.getList = function () {
        return this.http.get(this.exemploUrl)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    ExemploService.prototype.salvar = function (exemplo) {
    ...
    ExemploService.prototype.deletar = function (id) {
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' });
        var options = new http_2.RequestOptions({ headers: headers });
        return this.http.delete(this.exemploUrl + "/" + id, options);
    };
    //Crie esse método
    ExemploService.prototype.handleError = function (error) {
        var errMsg;
...
//# sourceMappingURL=exemplo.service.js.map